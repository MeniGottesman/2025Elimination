<footer class="fixed bottom-0 w-screen">
	<div class="mx-auto w-full max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
		<span class="text-sm text-gray-400 sm:text-center"
			>Made by <a href="https://github.com/ThePickleGawd" class="hover:underline">Dylan Lu</a>, improved by <a href="https://menigottesman.com/" class="hover:underline">Meni Gottesman</a></span>
>
