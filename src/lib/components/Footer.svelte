<footer class="fixed bottom-0 w-full bg-gray-800 text-white">
  <div class="mx-auto w-full max-w-screen-xl p-4 flex flex-col md:flex-row md:items-center md:justify-between">
